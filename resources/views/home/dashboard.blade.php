            ...
            <div class="w[110%]">
                <div class="row">
                    ...
                    <div class="col-sm- mt-[24px] float-right">
                        <button type="reset" class="btn btn-primary cus-btn-style bg-[#c2f2ff]" >@lang('lang.checkin')</button>
                        <button type="reset" class="btn btn-secondary cus-btn-style  bg-[#c5c8cc]" >@lang('lang.checkout')</button>
                    </div>
                </div>
            </div>
        </form>
