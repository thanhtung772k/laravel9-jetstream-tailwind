                        ...
                        <form action="{{route('insert_post')}}" method="POST" class="p-6" enctype="multipart/form-data">
                                    ...
                                    <div>
                                        <section>
                                            <div class="input-group date">
                                                <input class="form-control" id="fromDate" name="title" value="">
                                            </div>
                                        </section>
                                    </div>
                                </div>
                            ...
                            <div>
                                <div class="pt-4 add_timesheet-title">
                                    ...
                                    <div>
                                        <textarea class="form-control min-h-[270px]" name="content" rows="3"></textarea>
                                    </div>
                                    @error('reason')
                                    <div class="text-red-500">{{ $message }}</div>
                                    @enderror
                            ...
                            <div>
                                <div class="pt-4 add_timesheet-title">
                                    <label>@lang('client/lang.about_author') <span class="text-red-500">*</span></label>
                                    <div>
                                        <textarea class="form-control" name="author" rows="3"></textarea>
                                    </div>
                                    @error('reason')
                                    <div class="text-red-500">{{ $message }}</div>
                                    @enderror
